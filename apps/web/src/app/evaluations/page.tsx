  ...
  if (isPublicDemo) {
    return (
      <AppShell active="evaluations">
        <PublicDemoNotice
          eyebrow="Regression quality"
          title="Evaluations"
          description="Evaluation reports are generated by the backend tooling in the full local project. The public demo keeps evaluation execution offline while the repository includes the benchmark data and grading code."
        />
      </AppShell>
    );
  }
